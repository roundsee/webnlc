...
var x = class {
  constructor(t) {
    ...
    __publicField(this, "toolbarButtons", []);
...
var _v = class _v extends x {
  constructor() {
    ...
    __publicField(this, "onKeyUp", (t) => {
      ...
      i && (t.code === "ArrowLeft" ? (_v.placeCaretBeforeBlot(this.formatter.quill, i, this.debug), this.formatter.hide()) : t.code === "ArrowRight" && (_v.placeCaretAfterBlot(this.formatter.quill, i, this.debug), this.formatter.hide()));
    });
  }
};
/**
 ...
 */
__publicField(_v, "sendCaretBack", (t = 1, e = false) => {
  var _a;
  ...
  if (i && i.rangeCount > 0) {
    ...
    if (n > 0)
      ...
      r.nodeType === Node.TEXT_NODE && o.setStart(r, ((_a = r.textContent) == null ? void 0 : _a.length) || 0);
    }
    o.collapse(true), i.removeAllRanges(), i.addRange(o), e && console.debug("Caret moved back by", t, "characters");
  }
});
/**
 ...
 */
__publicField(_v, "placeCaretBeforeBlot", (t, e, i = false) => {
 ...
 */
__publicField(_v, "placeCaretAfterBlot", (t, e, i = false) => {
  t.setSelection(null), t.root.focus();
  const o = t.getIndex(e), s = t.getLength();
  o + 1 >= s - 1 ? (t.setSelection(s - 1, 0, "user"), i && console.debug("Caret placed at the end of the document after blot:", e)) : (i && console.debug("Caret placed after character following blot at index:", o, e), t.setSelection(o + 2, 0, "user"), _v.sendCaretBack(1, i));
});
var v = _v;
function R(h) {
...
function O() {
  ...
  function r(a, c) {
    return c.clone !== false && c.isMergeableObject(a) ? w(n(a), a, c) : a;
  }
  function l(a, c, d) {
...
var _E = class _E {
  ...
  constructor(t, e = false) {
     ...
     */
    __publicField(this, "destroy", () => {
      this.quill.container.querySelector(".ql-tooltip") && (_E.removeTooltipWatcher(this.quill, this.debug), this.debug && console.debug("Tooltip watcher removed on destroy"));
    });
    this.quill = t, this.debug = e;
    const i = t.container.querySelector(".ql-tooltip");
    console.debug("tooltip:", i), i ? (_E.watchTooltip(t, e), e && console.debug("Tooltip watcher initialized for:", i)) : console.warn("No tooltip found to watch for adjustments.");
  }
  /**
  ...
  static watchTooltip(t, e = false) {
    ...
    const n = new MutationObserver((r) => {
      if (!s) {
        ...
        s = true, this._repositionTooltip(i, o, e), setTimeout(() => {
          s = false;
        }, 0);
      }
    });
  ...
  static removeTooltipWatcher(t, e = false) {
    var _a;
    let i = null;
    t instanceof HTMLDivElement ? i = t : i = t.container.querySelector(".ql-tooltip"), i && this.observers.has(i) && ((_a = this.observers.get(i)) == null ? void 0 : _a.disconnect(), this.observers.delete(i), e && console.debug("Tooltip watcher removed for:", i));
  }
};
/**
 ...
 */
__publicField(_E, "_repositionTooltip", (t, e, i = false) => {
  ...
  let g = false;
  const b = {};
  r < 0 && (b.top = `${o.height}px`, g = true), r + p > u && (b.top = `${u - p}px`, g = true), n < 0 && (b.left = "0px", g = true), n + l > m && (b.left = `${m - l}px`, g = true), g ? (i && console.debug("Repositioning tooltip", b), b.top !== void 0 && (t.style.top = b.top), b.left !== void 0 && (t.style.left = b.left), t.classList.contains("ql-flip") && t.classList.remove("ql-flip")) : i && console.debug("Tooltip position is fine, no changes needed");
});
// Static property to store observers
__publicField(_E, "observers", /* @__PURE__ */ new WeakMap());
var E = _E;
var W = (h) => {
  var _a;
  const t = h.import("formats/image"), e = ["alt", "height", "width", "title"];
  return _a = class extends t {
    static formats(o) {
      return e.reduce(
  ...
  }, __publicField(_a, "blotName", "image"), _a;
};
var D = (h) => {
  var _a;
  ...
  return _a = class extends e {
    ...
    add(s, n) {
      if (this.debug && console.debug("IframeAlignAttributor.add", s, n), s instanceof HTMLElement) {
        ...
        return r ? (isNaN(Number(r.trim().slice(-1))) || (r = `${r}px`), s.style.setProperty("--resize-width", r), s.dataset.relativeSize = `${r.endsWith("%")}`) : (s.style.removeProperty("--resize-width"), s.dataset.relativeSize = "false"), this.debug && console.debug("IframeAlignAttributor.add - node:", s, "aligned with:", n), true;
      } else
  ...
  }, __publicField(_a, "attrName", "iframeAlign"), _a;
};
var j = (h) => {
  var _a;
  const t = h.import("parchment"), { ClassAttributor: e, Scope: i } = t;
  return _a = class extends e {
    ...
    add(s, n) {
      ...
      if (this.debug && console.debug("ImageAlignAttributor.add", s, n), s instanceof HTMLSpanElement && n) {
        ...
        return s.setAttribute("data-relative-size", `${l == null ? void 0 : l.endsWith("%")}`), true;
      } else {
        ...
        if (this.debug && console.debug(`ImageAlignAttributor.add - ${s.tagName} is not a span, checking for image:`, r), r instanceof HTMLImageElement) {
          const l = h.find(r);
          return this.debug && console.debug("ImageAlignAttributor.add - found image blot:", l), l && (s.firstChild instanceof HTMLSpanElement || !((_a2 = r.parentElement) == null ? void 0 : _a2.matches('span[class^="ql-image-align-"]'))) && (l.format("imageAlign", n), this.debug && console.debug("ImageAlignAttributor.add - reapplying imageAlign format to image blot:", n, l)), true;
        }
        return false;
      }
    }
  ...
  }, __publicField(_a, "tagName", "SPAN"), __publicField(_a, "attrName", "imageAlign"), _a;
};
var $ = (h) => {
  var _a;
  ...
  }, __publicField(_a, "blotName", "video"), __publicField(_a, "aspectRatio", "16 / 9 auto"), _a;
};
var P = class {
  constructor(t) {
    __publicField(this, "alignments", {});
     ...
     */
    __publicField(this, "getAlignments", () => Object.keys(this.alignments).map((t) => this.alignments[t]));
    /**
     ...
     */
    __publicField(this, "isInlineBlot", (t) => {
      var _a;
      return (((_a = t.statics) == null ? void 0 : _a.scope) & this.Scope.INLINE) === this.Scope.INLINE_BLOT;
    });
    /**
     ...
     */
    __publicField(this, "isBlockBlot", (t) => {
      var _a;
      return (((_a = t.statics) == null ? void 0 : _a.scope) & this.Scope.BLOCK) === this.Scope.BLOCK_BLOT;
    });
    /**
     ...
     */
    __publicField(this, "hasInlineScope", (t) => (t.statics.scope & this.Scope.INLINE) === this.Scope.INLINE);
    /**
     ...
     */
    __publicField(this, "hasBlockScope", (t) => (t.statics.scope & this.Scope.BLOCK) === this.Scope.BLOCK);
    /**
     ...
     */
    __publicField(this, "isAligned", (t, e) => {
     ...
     */
    __publicField(this, "getAlignment", (t) => t.domNode.dataset.blotAlign);
    /**
     ...
     */
    __publicField(this, "setAlignment", (t, e) => {
      if (t === null) {
...
var k = class {
  ...
  constructor(t, e, i) {
    ...
    __publicField(this, "initialVisibility", true);
    /**
     ...
     */
    __publicField(this, "preselect", () => false);
    /**
     ...
     * @private
     */
    __publicField(this, "_styleButton", () => {
  ...
  get selected() {
    var _a;
    return ((_a = this.element) == null ? void 0 : _a.dataset.selected) === "true";
  }
  /**
  ...
  get visible() {
    var _a;
    return ((_a = this.element) == null ? void 0 : _a.style.display) !== "none";
  }
  /**
...
var F = class extends x {
  constructor(t) {
    super(t);
    __publicField(this, "aligner");
    __publicField(this, "alignButtons", {});
    /**
     ...
     * @private
     */
    __publicField(this, "_createAlignmentButtons", () => {
      var _a;
      ...
      const t = (_a = this.formatter.currentSpec) == null ? void 0 : _a.getTargetBlot();
      if (t) {
     ...
     * @private
     */
    __publicField(this, "_clearButtons", () => {
     ...
     */
    __publicField(this, "onClickHandler", (t) => {
      var _a;
      const e = t.target.closest(`span.${this.formatter.options.toolbar.buttonClassName}`);
      if (e) {
        const i = e.dataset.action || "", o = (_a = this.formatter.currentSpec) == null ? void 0 : _a.getTargetBlot();
        if (i && o) {
          const s = this.aligner.alignments[i];
          this._clearButtons(), this.aligner.isAligned(o, s) ? (this.aligner.clear(o), this.debug && console.debug("AlignAction clear alignment:", i, o)) : (this.aligner.setAlignment(o, i), this.alignButtons[i].selected = true, this.debug && console.debug("AlignAction set alignment:", i, o));
        }
      }
    ...
    this.aligner = new P(t), t.options.debug && console.debug("AlignAction Aligner created:", this.aligner);
  }
};
...
var V = class extends x {
  constructor(t) {
    super(t);
    __publicField(this, "_topLeftHandle");
    __publicField(this, "_topRightHandle");
    __publicField(this, "_bottomRightHandle");
    __publicField(this, "_bottomLeftHandle");
    __publicField(this, "_dragHandle", null);
    __publicField(this, "_dragStartX", 0);
    __publicField(this, "_dragCursorStyle");
    __publicField(this, "_preDragWidth", 0);
    __publicField(this, "_pinchStartDistance", 0);
    __publicField(this, "_calculatedAspectRatio", 0);
    __publicField(this, "_computedAspectRatio");
    __publicField(this, "_target");
    __publicField(this, "_editorStyle");
    __publicField(this, "_editorWidth", 0);
    __publicField(this, "_useRelativeSize");
    __publicField(this, "_resizeModeButton", null);
    __publicField(this, "_isUnclickable", false);
    __publicField(this, "_hasResized", false);
    __publicField(this, "_formattedWidth", "");
    __publicField(this, "_sizeInfoTimerId", null);
    __publicField(this, "_isImage", false);
    __publicField(this, "_isSVG", false);
    __publicField(this, "_naturalWidth");
    /**
    ...
    __publicField(this, "onCreate", () => {
      var _a, _b;
      this._target = (_a = this.formatter.currentSpec) == null ? void 0 : _a.getTargetElement(), this._isUnclickable = ((_b = this.formatter.currentSpec) == null ? void 0 : _b.isUnclickable) || false, this._isImage = this._target instanceof HTMLImageElement, this._isImage && (this._isSVG = this._isSvgImage()), this.formatter.overlay.append(
        this._topLeftHandle,
     ...
     */
    __publicField(this, "_createHandle", (t, e) => {
     ...
     */
    __publicField(this, "_repositionHandles", (t) => {
      const e = (t == null ? void 0 : t.width) ? `${-parseFloat(t.width) / 2}px` : "0px", i = (t == null ? void 0 : t.height) ? `${-parseFloat(t.height) / 2}px` : "0px", { style: o } = this._topLeftHandle;
      o.left = e, o.top = i;
     ...
     */
    __publicField(this, "_setCursor", (t) => {
      if (!document.body) {
     ...
     */
    __publicField(this, "_resizeMode", (t) => {
      if (t) {
...
Using temporary aspect ratio "${this.formatter.options.video.defaultAspectRatio}"`
     ...
     */
    __publicField(this, "_onHandlePointerDown", (t) => {
     ...
     */
    __publicField(this, "_onHandleDrag", (t) => {
     ...
     */
    __publicField(this, "_onHandlePointerUp", () => {
     ...
     */
    __publicField(this, "_onOverlayTouchStart", (t) => {
     ...
     */
    __publicField(this, "_onOverlayTouchMove", (t) => {
     ...
     * @param event - The touch event triggered on the overlay.
     */
    __publicField(this, "_onOverlayTouchEnd", (t) => {
     ...
     */
    __publicField(this, "_onOverlayMouseDown", (t) => {
     ...
     */
    __publicField(this, "_onOverlayMouseUp", (t) => {
      t.target === this.formatter.overlay && this._resizeMode(false);
    });
    /**
     ...
     */
    __publicField(this, "_resizeTarget", (t) => {
      if (!this._target) {
     ...
     */
    __publicField(this, "_showSizeInfo", (t, e = null, i = null) => {
     ...
     */
    __publicField(this, "_updateSizeInfo", (t, e) => {
     ...
     */
    __publicField(this, "_createResizeModeButton", () => {
      const t = new k(
        "resizeMode",
     ...
     */
    __publicField(this, "_onResizeModeClickHandler", (t) => {
     ...
     */
    __publicField(this, "_swapResizeMode", (t = false) => {
      var _a;
      if (this._target) {
        const e = this._target.getBoundingClientRect();
        ...
        let i, o;
        this.isRelative ? (i = `${Math.round(e.width)}px`, o = this.formatter.options.image.autoHeight ? "auto" : `${Math.round(e.height)}px`) : (i = `${Math.round(100 * e.width / this._editorWidth)}%`, o = "auto"), this._target.setAttribute("width", `${i}`), this._target.setAttribute("height", `${o}`), ((_a = this.formatter.currentSpec) == null ? void 0 : _a.isUnclickable) ? (this._target.style.setProperty("--resize-width", `${i}`), this._target.dataset.relativeSize = `${this.isRelative}`) : this.isAligned && this._target.parentElement && (this._target.parentElement.style.setProperty("--resize-width", `${i}`), this._target.parentElement.dataset.relativeSize = `${this.isRelative}`), this.formatter.toolbar.buttons.resizeMode.selected = this.isRelative, this.formatter.update(), t && (this._showSizeInfo(true, e.width, e.height), this._showSizeInfo(false)), this.debug && console.debug("ResizeAction resize mode swapped:", {
          target: this._target,
          newWidth: i,
          isRelative: this.isRelative,
          isAligned: this.isAligned
     ...
     */
    __publicField(this, "_closeSizeInfo", () => {
     ...
     */
    __publicField(this, "_cancelSizeInfoTimer", () => {
     ...
     */
    __publicField(this, "_calculateDistance", (t, e) => {
     ...
     */
    __publicField(this, "_roundDimension", (t) => t.replace(/([^0-9.-]*)(-?[\d.]+)(.*)/, (e, i, o, s) => `${i}${Math.round(Number(o))}${s}`));
    /**
     ...
     */
    __publicField(this, "_isSvgImage", () => this._target instanceof HTMLImageElement ? this._target.src.startsWith("data:image/") ? this._target.src.includes("image/svg+xml") : this._target.src.endsWith(".svg") : false);
    this._topLeftHandle = this._createHandle("top-left", "nwse-resize"), this._topRightHandle = this._createHandle("top-right", "nesw-resize"), this._bottomRightHandle = this._createHandle("bottom-right", "nwse-resize"), this._bottomLeftHandle = this._createHandle("bottom-left", "nesw-resize"), this._dragCursorStyle = document.createElement("style"), this._useRelativeSize = this.formatter.options.resize.useRelativeSize, t.options.resize.allowResizeModeChange && (this._resizeModeButton = this._createResizeModeButton(), this.toolbarButtons = [
      this._resizeModeButton
    ]);
  }
  get isRelative() {
    var _a, _b;
    return ((_b = (_a = this._target) == null ? void 0 : _a.getAttribute("width")) == null ? void 0 : _b.endsWith("%")) || false;
  }
  get isAligned() {
...
var M = class {
  constructor(t) {
    ...
    __publicField(this, "formatter");
    __publicField(this, "isUnclickable", false);
    /**
     ...
     */
    __publicField(this, "getTargetElement", () => null);
    /**
     ...
     */
    __publicField(this, "getTargetBlot", () => {
     ...
     */
    __publicField(this, "getOverlayElement", () => this.getTargetElement());
    /**
...
var X = "blot-formatter__proxy-image";
var Y = class extends M {
  constructor(t) {
    super(t);
    __publicField(this, "selector");
    __publicField(this, "unclickable");
    __publicField(this, "proxyContainer");
    __publicField(this, "unclickableProxies");
    __publicField(this, "isUnclickable", true);
    /**
     ...
     */
    __publicField(this, "_observeEditorResize", () => {
      let t = null;
     ...
     */
    __publicField(this, "getTargetElement", () => this.unclickable);
    /**
     ...
     */
    __publicField(this, "getOverlayElement", () => this.unclickable);
    /**
     ...
     */
    __publicField(this, "_onTextChange", () => {
     ...
     */
    __publicField(this, "_createUnclickableProxyImage", (t) => {
      const e = Array.from(
      ...
      }), s.addEventListener("wheel", this.formatter._passWheelEventThrough), s.addEventListener("touchstart", this.formatter._onTouchScrollStart, { passive: false }), s.addEventListener("touchmove", this.formatter._onTouchScrollMove, { passive: false }), this.unclickableProxies[e] = {
        unclickable: t,
        proxyImage: s
     ...
     * @private
     */
    __publicField(this, "_repositionProxyImages", () => {
     ...
     */
    __publicField(this, "_onProxyImageClick", (t) => {
     ...
     * @private
     */
    __publicField(this, "_createProxyContainer", () => {
      const t = document.createElement("div");
      return t.classList.add("proxy-container"), this.formatter.quill.container.appendChild(t), t;
    });
    this.selector = t.options.video.selector, this.unclickable = null, this.proxyContainer = this._createProxyContainer(), this.unclickableProxies = {};
  }
};
...
var K = class extends x {
  constructor(t) {
    ...
    __publicField(this, "currentBlot", null);
    /**
    ...
    __publicField(this, "onCreate", () => {
      var _a, _b;
      this.targetElement = (_a = this.formatter.currentSpec) == null ? void 0 : _a.getTargetElement(), this.currentBlot = (_b = this.formatter.currentSpec) == null ? void 0 : _b.getTargetBlot();
    });
    /**
     * Cleans up resources when the action is destroyed.
     ...
     */
    __publicField(this, "_onClickHandler", () => {
     ...
     * @private
     */
    __publicField(this, "_showAltTitleModal", () => {
     ...
     * @private
     */
    __publicField(this, "_hideAltTitleModal", () => {
     ...
     * @private
     */
    __publicField(this, "_setAltTitle", () => {
      var _a, _b, _c, _d;
      if (this.targetElement) {
        ...
        const i = (_c = (_b = (_a = this.currentBlot) == null ? void 0 : _a.parent) == null ? void 0 : _b.formats()[this.formatter.ImageAlign.attrName]) == null ? void 0 : _c.align;
        this.currentBlot && i && (this.formatter.options.debug && console.debug("Updating title of image with alignment:", i), (_d = this.currentBlot.parent) == null ? void 0 : _d.format(this.formatter.ImageAlign.attrName, false), this.currentBlot.format(
          this.formatter.ImageAlign.attrName,
          {
            align: i,
            title: e
     ...
     */
    __publicField(this, "_createModal", () => {
      var _a, _b;
      const t = Array.from(
        crypto.getRandomValues(new Uint8Array(5)),
      ...
      s.setAttribute("for", "alt"), s.textContent = ((_a = this.formatter.options.overlay.labels) == null ? void 0 : _a.alt) || this.formatter.options.image.altTitleModalOptions.labels.alt;
      const n = document.createElement("textarea");
      n.name = "alt", n.rows = 3;
      const r = document.createElement("label");
      r.setAttribute("for", "title"), r.textContent = ((_b = this.formatter.options.overlay.labels) == null ? void 0 : _b.title) || this.formatter.options.image.altTitleModalOptions.labels.title;
    ...
    __publicField(this, "_onSubmitHandler", (t) => {
      t.preventDefault(), this._setAltTitle(), this._hideAltTitleModal();
    });
    __publicField(this, "_onPointerDownHandler", (t) => {
...
var _A = class _A extends x {
  constructor(t) {
    super(t);
    __publicField(this, "options");
    __publicField(this, "modal");
    __publicField(this, "targetElement", null);
    __publicField(this, "imageDetails", null);
    /**
    ...
    __publicField(this, "onCreate", () => {
      var _a;
      this.targetElement = (_a = this.formatter.currentSpec) == null ? void 0 : _a.getTargetElement();
      const t = _A.isEligibleForCompression(this.targetElement, this.debug);
     ...
     */
    __publicField(this, "_parseDimensions", (t) => {
     ...
     */
    __publicField(this, "_getImageSize", (t) => {
     ...
     */
    __publicField(this, "_displayFeedback", (t) => {
     ...
     */
    __publicField(this, "_getImageDetails", (t) => {
      ...
      const o = {
        ...
        canCompress: !!(e && i && e < t.naturalWidth && _A.isEligibleForCompression(t, this.debug))
      };
     ...
     */
    __publicField(this, "_compressImage", (t) => {
      var _a;
      if ((_a = this.imageDetails) == null ? void 0 : _a.canCompress) {
        const e = new Image();
    ...
    __publicField(this, "_onBackgroundClick", (t) => {
    ...
    this.options = this.formatter.options.image.compressorOptions, this.toolbarButtons = [
      new k(
        "compress",
        this._onClickHandler,
        this.formatter.options.toolbar
 ...
 */
__publicField(_A, "isEligibleForCompression", (t, e = false) => {
  let i = false;
...
var Z = class extends x {
  constructor(t) {
    ...
    __publicField(this, "targetElement", null);
    __publicField(this, "currentBlot", null);
    __publicField(this, "toolbarButton");
    __publicField(this, "linkOptions");
    __publicField(this, "modal");
    /**
     ...
     * @private
     */
    __publicField(this, "_removeEventListeners", () => {
     ...
     */
    __publicField(this, "_trapContextEvent", (t) => {
    ...
    __publicField(this, "_onBackgroundClick", (t) => {
      var _a;
      t.target === ((_a = this.modal) == null ? void 0 : _a.background) && (t.stopImmediatePropagation(), t.preventDefault(), this.hideLinkModal(), this.debug && console.debug("LinkAction modal background clicked, hiding modal"));
    });
    /**
     ...
     * @returns {void}
     */
    __publicField(this, "showLinkModal", () => {
      if (this.targetElement) {
     ...
     */
    __publicField(this, "_buildModal", () => {
      ...
      o.type = "url", o.id = "link-url", o.name = "url", o.value = this.getLink() || "", o.select(), o.autofocus = true, o.className = this.linkOptions.modal.input.className, Object.assign(o.style, this.linkOptions.modal.input.style), o.placeholder = this.linkOptions.modal.input.placeholder || "";
     ...
     */
    __publicField(this, "_positionModal", (t) => {
      var _a;
      const e = this.formatter.overlay.getBoundingClientRect(), i = this.formatter.quill.root.getBoundingClientRect(), o = ((_a = t.offsetParent) == null ? void 0 : _a.getBoundingClientRect()) ?? { top: 0, left: 0 }, s = t.offsetWidth, n = t.offsetHeight;
     ...
     */
    __publicField(this, "hideLinkModal", () => {
      var _a, _b, _c, _d, _e;
      ((_b = (_a = this.modal) == null ? void 0 : _a.dialog) == null ? void 0 : _b.open) && this.modal.dialog.close(), (_d = (_c = this.modal) == null ? void 0 : _c.dialog) == null ? void 0 : _d.remove(), ((_e = this.modal) == null ? void 0 : _e.background) && this.modal.background.remove(), this._removeEventListeners(), this.modal = void 0;
    });
    /**
     ...
     */
    __publicField(this, "_formSubmitHandler", (t) => {
      t.preventDefault();
     ...
     */
    __publicField(this, "applyLink", (t) => {
      var _a;
      t !== this.getLink() && (this.removeLink(), (_a = this.currentBlot) == null ? void 0 : _a.format("link", t), this.toolbarButton.selected = !!t), this.hideLinkModal();
    });
    this.linkOptions = this.formatter.options.image.linkOptions, this.toolbarButton = new k(
      "link",
      this._onClickHandler,
      this.formatter.options.toolbar
...
var G = class extends M {
  constructor(t) {
     ...
     */
    __publicField(this, "getTargetElement", () => this.img);
    /**
...
var J = '<svg viewBox="0 0 512 512" fill="currentcolor" style="height:100%;width:auto"><path d="M464 256A208 208 0 1 0 48 256a208 208 0 1 0 416 0zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zm169.8-90.7c7.9-22.3 29.1-37.3 52.8-37.3l58.3 0c34.9 0 63.1 28.3 63.1 63.1c0 22.6-12.1 43.5-31.7 54.8L280 264.4c-.2 13-10.9 23.6-24 23.6c-13.3 0-24-10.7-24-24l0-13.5c0-8.6 4.6-16.5 12.1-20.8l44.3-25.4c4.7-2.7 7.6-7.7 7.6-13.1c0-8.4-6.8-15.1-15.1-15.1l-58.3 0c-3.4 0-6.4 2.1-7.5 5.3l-.4 1.2c-4.4 12.5-18.2 19-30.6 14.6s-19-18.2-14.6-30.6l.4-1.2zM224 352a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z" /></svg>';
var tt = {
  specs: [
    G,
    Q
...
var __ = class __ {
  constructor(t, e = {}) {
    ...
    __publicField(this, "_tooltipContainPosition");
    __publicField(this, "ImageAlign");
    __publicField(this, "IframeAlign");
    /**
    ...
    __publicField(this, "destroy", () => {
      var _a, _b, _c, _d;
      try {
        this.hide(), this._removeEventListeners(), this._destroyActions(), (_a = this.toolbar) == null ? void 0 : _a.destroy(), ((_b = this.overlay) == null ? void 0 : _b.parentNode) && this.overlay.parentNode.removeChild(this.overlay), this.currentSpec = null, this.specs = [], this.actions = [], ((_c = this.options.tooltip) == null ? void 0 : _c.containTooltipPosition) && this._tooltipContainPosition && ((_d = this._tooltipContainPosition) == null ? void 0 : _d.destroy()), window.bf === this && delete window.bf, this.quill = null, this.options.debug && console.debug("BlotFormatter destroyed");
      } catch (t) {
     ...
     */
    __publicField(this, "_qlDisabledObserver", new MutationObserver((t) => {
      t.forEach((e) => {
     ...
     */
    __publicField(this, "hide", (t = null) => {
      if (this.currentSpec) {
        if (t) {
     ...
     */
    __publicField(this, "_createActions", (t) => {
     ...
     * @private
     */
    __publicField(this, "_destroyActions", () => {
     ...
     */
    __publicField(this, "_scrollToolbarIntoView", async (t) => {
      var _a;
      let e = t.getBoundingClientRect();
      const i = this.quill.container.getBoundingClientRect(), o = (_a = this.currentSpec) == null ? void 0 : _a.getTargetElement();
     ...
     */
    __publicField(this, "_scrollIntoViewWithOffset", (t, e = 10) => new Promise((i) => {
      let o = null;
    ...
    __publicField(this, "_removeEventListeners", () => {
      var _a, _b;
      (_a = this._abortController) == null ? void 0 : _a.abort(), (_b = this._resizeObserver) == null ? void 0 : _b.disconnect(), this._qlDisabledObserver.disconnect();
    });
    /**
     ...
     */
    __publicField(this, "_preventContextMenu", (t) => {
     ...
     * @private
     */
    __publicField(this, "_repositionOverlay", () => {
      if (this.currentSpec) {
     ...
     */
    __publicField(this, "_setUserSelect", (t) => {
      [
        "userSelect",
        "mozUserSelect",
        "webkitUserSelect",
     ...
     */
    __publicField(this, "_onDocumentPointerDown", (t) => {
      const e = t.target;
     ...
     */
    __publicField(this, "_passWheelEventThrough", (t) => {
     ...
     */
    __publicField(this, "_onTouchScrollStart", (t) => {
     ...
     */
    __publicField(this, "_onTouchScrollMove", (t) => {
      if (t.touches.length === 1) {
        ...
        let g = false;
        m && !(n && o < 0) && !(r && o > 0) && (g = true, s.scrollTop += o), u && !(l && i < 0) && !(p && i > 0) && (g = true, s.scrollLeft += i), g && t.preventDefault(), this._startX = e.clientX, this._startY = e.clientY, this.options.debug && console.debug("BlotFormatter touch scroll end", `X: ${this._startX}, Y: ${this._startY}`);
      }
    });
    /**
     ...
     * @private
     */
    __publicField(this, "_registerCustomBlots", () => {
     ...
     * @private
     */
    __publicField(this, "_keyboardBindings", () => {
      if (this.options.video.registerBackspaceFix) {
        ...
        const t = {
          ...
          handler: (e) => {
            ...
            if (((_a = i == null ? void 0 : i.domNode) == null ? void 0 : _a.tagName) !== "IFRAME")
              return true;
      ...
      if (this.options.image.registerArrowRightFix) {
        ...
        const t = {
          ...
          handler: (e) => {
            ...
            if (!(o == null ? void 0 : o.domNode))
              return true;
            const s = o.domNode;
            if ((s == null ? void 0 : s.tagName) !== "IMG" || !((_a = s.parentElement) == null ? void 0 : _a.matches('span[contenteditable="false"]')))
              return true;
     ...
     */
    __publicField(this, "_useRelative", (t) => {
     ...
     */
    __publicField(this, "_getClickPosition", (t) => {
    ...
    var _a, _b;
    this.Quill = t.constructor, this.quill = t, this.currentSpec = null, this.actions = [], e.debug && (window.blotFormatter = this), __.registerFormats(this.Quill, e.debug), this.ImageAlign = __.cache.ImageAlign, this.IframeAlign = __.cache.IframeAlign, this.options = N(tt, e, { arrayMerge: et }), e.debug && console.debug("BlotFormatter options", this.options), this._enabled = !(this.quill.options.readOnly || this.quill.container.classList.contains("ql-disabled"));
    ...
    i.innerHTML = ".ql-disabled .blot-formatter__proxy-image {display: none;}", document.head.appendChild(i), [this.overlay, this.sizeInfo] = this._createOverlay(), this._addEventListeners(), this.toolbar = new q(this), e.debug && console.debug("BlotFormatter toolbar", this.toolbar), this.specs = this.options.specs.map(
      (o) => new o(this)
    ), this.specs.forEach((o) => o.init()), e.debug && console.debug("BlotFormatter specs", this.specs), this.quill.container.style.position = this.quill.container.style.position || "relative", this._registerCustomBlots(), this._keyboardBindings(), this.options.debug && console.debug("tooltip option", (_a = this.options.tooltip) == null ? void 0 : _a.containTooltipPosition), ((_b = this.options.tooltip) == null ? void 0 : _b.containTooltipPosition) && (this._tooltipContainPosition = new E(this.quill, this.options.debug));
  }
  static registerFormats(t, e = false) {
    __.registerImageAlign(t, e), __.registerIframeAlign(t, e);
  }
  static registerImageAlign(t, e = false) {
    var _a;
    if ((_a = t.imports) == null ? void 0 : _a["formats/imageAlign"])
      e && console.debug("Image align format already registered with Quill, skipping registration");
    else {
      const i = j(t), o = new i(e);
      __.cache.ImageAlign = o, e && console.debug("Registering imageAlign format with Quill", o), t.register({
        "formats/imageAlign": o,
        "attributors/class/imageAlign": o
      });
    }
  }
  static registerIframeAlign(t, e = false) {
    var _a;
    if ((_a = t.imports) == null ? void 0 : _a["formats/iframeAlign"])
      e && console.debug("Iframe align format already registered with Quill, skipping registration");
    else {
      const i = D(t), o = new i(e);
      __.cache.IframeAlign = o, e && console.debug("Registering iframeAlign format with Quill", o), t.register({
...
//# sourceMappingURL=@enzedonline_quill-blot-formatter2.js.map
